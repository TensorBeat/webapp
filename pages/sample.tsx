...
const cloud_bucket_songs = [
    {
        name: "Recomposed",
        url: "https://storage.googleapis.com/sarosh-gen/mp3s/Recomposed.mp3",
    },
    {
        name: "Jazz Conditioned",
        url: "https://storage.googleapis.com/sarosh-gen/mp3s/jazz_v2.mp3",
    },
    {
    ...
    {
        name: "Boss Music",
        url: "https://storage.googleapis.com/sarosh-gen/mp3s/Boss%20Music.mp3",
    },
    {
        name: "GSU Theme",
        url: "https://storage.googleapis.com/sarosh-gen/mp3s/GSU_Theme.mp3",
    },
    {
        name: "Recomposed 2",
        url:
    ...
    },
    {
        ...
        url: "https://storage.googleapis.com/sarosh-gen/mp3s/Happier.mp3",
    },
    {
        name: "Luke's Piano",
        url:
    ...
    {
        name: "Test Output 3",
        url: "https://storage.googleapis.com/sarosh-gen/mp3s/test_output_3.mp3",
    },
    {
        name: "Test Output 5",
        url:
            ...
            <main className={pageStyles.main}>
                <div className={pageStyles.section}>
                    ...
                    {cloud_bucket_songs.map((song, index) => (
                        <div className={pageStyles.row} key={index}>
                            <h3 style={{ marginRight: "1em" }}>{song.name}</h3>
                            <audio controls>
